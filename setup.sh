...
[[rule]]
toolName = "mcp__urc_coordination__health_check"
decision = "allow"
priority = 100

[[rule]]
toolName = "mcp__urc_coordination__claim_task"
decision = "allow"
priority = 100

[[rule]]
toolName = "mcp__urc_coordination__complete_task"
decision = "allow"
priority = 100
...
[[rule]]
toolName = "mcp__urc_coordination__report_event"
decision = "allow"
priority = 100
...
[[rule]]
toolName = "mcp__urc_coordination__relay_forward"
decision = "allow"
priority = 100

[[rule]]
toolName = "mcp__urc_coordination__relay_read"
decision = "allow"
priority = 100
...
priority = 100
POLICYEOF
      ok "Gemini policy rules created at ~/.gemini/policies/urc-mcp.toml (32 tools)"
    fi
  else
    echo ""
